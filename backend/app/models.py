...
class LlamaService(Base):
    ...
    service_type: Mapped[str] = mapped_column(String(32), default="exec")
    restart_policy: Mapped[str] = mapped_column(String(32), default="on-failure")
    restart_sec: Mapped[int] = mapped_column(Integer, default=3)
